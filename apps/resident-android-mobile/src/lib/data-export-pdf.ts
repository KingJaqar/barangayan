...
// printable HTML report for expo-print (Download My Data → PDF option).
//
 ...
 * ready for Print.printToFileAsync(). */
...
<body>
  ...
  ${sections}
  <footer>This document was generated on-device from your Barangayan account under the Data Privacy Act's right to data portability.</footer>
</body>
</html>`;
}
