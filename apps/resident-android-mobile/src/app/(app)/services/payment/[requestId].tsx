...
export default function PaymentMethodScreen() {
  ...
  // Shipping applies to every request — QR Ph and Cash on Delivery both end in
  // out_for_delivery, there's no in-person-pickup path.
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.primary }]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.amountRow}>
          ...
          <ThemedText type="small">{shippingFee === 0 ? 'Free' : formatCentavosAsPHP(shippingFee)}</ThemedText>
        </View>
        <View style={styles.amountRow}>
