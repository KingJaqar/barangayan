...
/**
 * Ported from mobile's PaymentMethodScreen. Pay at Pickup is always available; QR PH
 * stays visible and selectable (so residents can see what's coming) but is gated behind
 * PAYMENT_SETTLEMENT_READY.
 */
export function PaymentMethodForm({
  ...
  async function handleContinue() {
    ...
    router.replace(selected === 'pickup' ? `/services/payment/pickup/${requestId}` : `/services/payment/qrph/${requestId}`);
    router.refresh();
  }
