  ...
  return (
    <div className="flex min-h-full flex-1 items-center justify-center bg-zinc-50 dark:bg-black">
      <form
        ...
        <Link
          href="/login"
          className="mb-4 inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-[#0F6E5B]">
          ← Back to Login
        </Link>

        <h1 className="mb-1 text-center text-2xl font-bold text-[#0F6E5B]">Forgot Password</h1>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-full bg-[#0F6E5B] py-2.5 text-sm font-semibold text-white disabled:opacity-50">
