          ...
          <div className="text-sm">
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                className="self-start rounded-full border border-dashed border-zinc-300 px-3 py-1 text-xs font-semibold text-zinc-600 hover:border-[#0F6E5B] hover:text-[#0F6E5B] dark:border-zinc-700 dark:hover:border-[#0F6E5B]">
                + Add Step
              </button>
            </div>
          </div>
              ...
              {PRESET_COLORS.map((color) => (
                <button
                  ...
                  className={`h-8 w-8 rounded-full border-2 ${
                    iconColor === color.value ? 'border-[#0F6E5B]' : 'border-transparent'
                  }`}
            ...
            <div className="flex flex-wrap gap-2">
              {PRESET_COLORS.map((color) => (
                <button
                  ...
                  className={`h-8 w-8 rounded-full border-2 ${
                    iconBg === color.bg ? 'border-[#0F6E5B]' : 'border-transparent'
                  }`}
