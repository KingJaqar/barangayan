  ...
  return (
    <div className="min-w-56 space-y-2.5 p-1">
      <div className="flex items-start gap-2">
        <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#0F6E5B]/10">
          <MapPin className="h-3 w-3 text-[#0F6E5B]" strokeWidth={2.5} />
        </div>
      ...
      <div className="ml-7 pt-1">
        <Link
          ...
          className="inline-flex items-center gap-1 text-xs font-semibold text-[#0F6E5B] transition-colors duration-200 hover:text-[#0a5a4a] hover:underline">
