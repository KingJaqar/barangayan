              ...
              <div className="flex items-center justify-between">
                ...
                {unreadCount > 0 ? (
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-[#0F6E5B] hover:underline"
                  >
                ...
                filteredNotifications.map((n) => (
                  <button
                    ...
                    className={`flex w-full flex-col gap-0.5 px-4 py-3 text-left text-sm transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800 ${
                      !n.is_read ? 'bg-[#0F6E5B]/5 dark:bg-[#0F6E5B]/10' : ''
                    }`}
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {!n.is_read ? (
                        <span className="mt-1 h-2 w-2 shrink-0 rounded-full bg-[#0F6E5B]" />
                      ) : null}
                    </div>
